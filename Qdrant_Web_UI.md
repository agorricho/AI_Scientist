...
You can navigate to these options directly. For example, if you used our quick start to set up a cluster on localhost, you can review our tutorial at http://localhost:6333/dashboard#/tutorial.